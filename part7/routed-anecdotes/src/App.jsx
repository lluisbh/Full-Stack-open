...
const CreateNew = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    props.notification(`a new anecdote "${content.value}" created!`, 5)
    navigate('/')
  }
...
const App = () => {
  ...
  const newNotification = (text, seconds) => {
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path='/create' element={<CreateNew addNew={addNew} notification={newNotification}/>} />
